...
choice1 = input('You\'re at a crossroad,where do you wanna go? Type "Left" or "Right".\n').lower()
...
if choice1 == "left":
     ...
     if choice2 == "wait":
        ...
        if choice3 == "red":
           print("Game over,you jumped into fire.")
        elif choice3 == "yellow":
           print("You win")
        else:
           print("Game over,you have eaten by a beast.")
     else:
